...
def beregn_nedbetalingstid(
    ...
    årlig_eksport_btc_start = eksport_kwh * spotpris_nok * btc_eksportandel
    ...
    for år in range(1, 51):
        akkumulert_btc = (akkumulert_btc + årlig_eksport_btc_start) * (1 + btc_vekst_aar)
        total_inntekt += årlig_besparelse + akkumulert_btc
